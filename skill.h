...
#define MAX_SKILL_CRIMSON_MARKER  5
#define MAX_SKILL_NARA_MARKER  5
...
// will have their IDs changed
	...
	BOR_NARAKUMI,
	//SKILLS HATEFFECT
	BOR_KATON01,//Katon - Zanmai no Shinka
	BOR_SUITON01,//Suiton - Suishouha
	BOR_SUITON02,//Suiton - Suiryudan no Jutsu
	BOR_SUITON03,//Suiton - Suirou no Jutsu
	BOR_SUITON04,//Suiton - Suidan no Jutsu
	BOR_KATON02,//Katon - Goukakyuu no Jutsu
	BOR_KATON03,//Katon - Gouryuka no Jutsu
	BOR_KATON04,//Katon - Ryuuen Houka no Jutsu
	BOR_KATON05,//Katon- Gouka Mekkyaku
	BOR_MEDICINA01,//Cicatrização
	BOR_MEDICINA02,//In'yu Shometsu
	BOR_TERREMOTO,
	BOR_RELAMPAGO,
	BOR_RAITON_F,
	...
	BOR_BYAKUGAN_CONTROL,//skill de controle byakugan
	BOR_RAITON_F2,//skill de teste hateffect
	BOR_MS_SAPO,//modo sanin dos sapos
	BOR_MS_COBRA,//modo sanin das cobras
	BOR_SANIN_SAPO_TRAINING,//aprimoramento sanin gama
	BOR_SANIN_COBRA_TRAINING,//aprimoramento sanin hebi
	BOR_LOTUS_COMBO_4 = 1020,
	BOR_LOTUS_COMBO_8,
	BOR_LOTUS_COMBO_16,
	BOR_LOTUS_COMBO_32,
	BOR_LOTUS_COMBO_64,
	...
	BOR_BYAK_FULL,
	BOR_LOTUS_OC,
	BOR_SANIN_GP01,// Taijutsu Gama #1
	BOR_SANIN_GP02,// Taijutsu Gama #2
	BOR_SANIN_HP01,
	BOR_SANIN_HP02,
	BOR_BANSHOTENIN,
	BOR_CHIBAKUTENSEI,
...
struct s_skill_db {
	...
	int skill_damage_id, flag_type[MAX_SKILL_LEVEL], dano_player[MAX_SKILL_LEVEL];
	int dano_monstro[MAX_SKILL_LEVEL], dano_mvp[MAX_SKILL_LEVEL], dano_outros[MAX_SKILL_LEVEL];
	int dano_type, dano_type2;
#ifdef RENEWAL_CAST
...
BEGIN_ZEROED_BLOCK; // This block will be zeroed in skill_defaults() as well as skill_readdb()
	...
	struct s_skill_lotus_db lotus_db[MAX_SKILL_LOTUS_DB];
...
int (*get_index) (int skill_id);
	...
	//sistema de balanceamento de skills
	//pedrodks
	int (*get_skilldamage_id) (int skill_id, int skill_lv);
	int (*get_skilldamage_flagtype) (int skill_id, int skill_lv);
	int (*get_skilldamage_danoplayer) (int skill_id, int skill_lv);
	int (*get_skilldamage_danomonstro) (int skill_id, int skill_lv);
	int (*get_skilldamage_danomvp) (int skill_id, int skill_lv);
	int (*get_skilldamage_outros) (int skill_id, int skill_lv);
	int (*get_skilldamage_type) (int skill_id, int skill_lv);
	int (*get_skilldamage_type2) (int skill_id, int skill_lv);
	...
	bool (*parse_row_skilldamage) (char* split[], int columns, int current);
	...
	bool (*parse_row_lotusdb) (char* split[], int columns, int current);
