...
#define set_sc_with_vfx(skill, sc, icon, flag) do { status->set_sc((skill), (sc), (icon), (flag)); if((icon) < SI_MAX) status->dbs->RelevantBLTypes[(icon)] |= BL_SCEFFECT; } while(0)
	...
	add_sc(BOR_8TRIG, SC_SUB_WEAPONPROPERTY);
	...
	//pedrodks
	//skills em area sistema hateffect
	add_sc(BOR_DOTON01, SC_BLOODING);
	add_sc(BOR_TERREMOTO, SC_BLOODING);
	add_sc(BOR_KATON02, SC_BURNING);
	add_sc(BOR_CHIBAKUTENSEI, SC_BLOODING);
	add_sc(BOR_AMATERASU, SC_AMATERASUTIME);
	add_sc(BOR_CHOUJI_01, SC_STUN);

	add_sc(WZ_FROSTNOVA, SC_FREEZE);
	add_sc(WZ_STORMGUST, SC_FREEZE);
	status->set_sc(WZ_QUAGMIRE, SC_QUAGMIRE, SI_QUAGMIRE, SCB_AGI | SCB_DEX | SCB_ASPD | SCB_SPEED);
	status->set_sc(MG_FIREWALL, SC_FIREWALL, SI_BLANK, SCB_SPEED);
	...
	//
	status->set_sc(BOR_GEN_01, SC_BLIND, SI_BLANK, SCB_NONE);
	status->set_sc(BOR_GEN_02, SC_STUN, SI_BLANK, SCB_NONE);
	status->set_sc(BOR_GBUFF01, SC_GEN01, SI_BLANK, SCB_NONE);
	status->set_sc(BOR_GBUFF02, SC_GEN02, SI_BLANK, SCB_NONE);
	//
	...
	status->set_sc(BOR_TSUKUYOMI, SC_STUN, SI_BLANK, SCB_NONE);
	status->set_sc(BOR_KANENOOTO, SC_ILLUSION, SI_ILLUSION, SCB_NONE);
	status->set_sc(BOR_KOKUANGYO, SC_BLIND, SI_BLANK, SCB_HIT | SCB_FLEE);
	set_sc_with_vfx(BOR_GENWAKU, SC_SIREN, SI_SIREN, SCB_NONE);
	status->set_sc(BOR_NARAKUMI, SC_FEAR, SI_BLANK, SCB_FLEE | SCB_HIT);
	status->set_sc(BOR_NEHAN, SC_SLEEP, SI_BLANK, SCB_NONE);
	status->set_sc(BOR_ROKUJUYON, SC_STUN, SI_BLANK, SCB_NONE);
	status->set_sc(BOR_LOTUS_OC, SC_STUN, SI_BLANK, SCB_NONE);
	...
	add_sc(BOR_NARA_03, SC_NARA_03_WAIT);
	add_sc(BOR_NARA_03, SC_NARA_03);
	...
	status->set_sc(BA_POEMBRAGI, SC_POEMBRAGI, SI_BLANK, SCB_NONE);
	...
	status->set_sc(LK_CONCENTRATION, SC_LKCONCENTRATION , SI_LKCONCENTRATION, SCB_WATK);
#else
	...
	status->set_sc(BOR_NARA_04, SC_RG_CCONFINE_S, SI_RG_CCONFINE_S, SCB_NONE);
	status->set_sc(BOR_NARA_04, SC_RG_CCONFINE_M, SI_RG_CCONFINE_M, SCB_FLEE);
	status->set_sc(BOR_NARA_05, SC_RG_CCONFINE_S, SI_RG_CCONFINE_S, SCB_NONE);
	status->set_sc(BOR_NARA_05, SC_RG_CCONFINE_M, SI_RG_CCONFINE_M, SCB_FLEE);
	status->set_sc(BOR_NARA_06, SC_RG_CCONFINE_S, SI_RG_CCONFINE_S, SCB_NONE);
	status->set_sc(BOR_NARA_06, SC_RG_CCONFINE_M, SI_RG_CCONFINE_M, SCB_FLEE);
	...
	status->set_sc(BG_BATTLEORDER, SC_GDSKILL_BATTLEORDER, SI_BLANK, SCB_STR | SCB_INT | SCB_DEX);
	status->set_sc(BG_REGENERATION, SC_GDSKILL_REGENERATION, SI_BLANK, SCB_REGEN);
	...
	**/
	...
	add_sc(BOR_SUITON03, SC_FROSTMISTY);
	...
	case 0:
		break;
	case 1:
		add_sc(BOR_LOTUS_COMBO_4, SC_SLEEP);
		break;
	case 2:
		add_sc(BOR_LOTUS_COMBO_4, SC_STUN);
		break;
	case 3:
		add_sc(BOR_LOTUS_COMBO_4, SC_CONFUSION);
		break;
	case 4:
		add_sc(BOR_LOTUS_COMBO_4, SC_BLIND);
		break;
	case 5:
		add_sc(BOR_LOTUS_COMBO_128, SC_BLOODING);
		break;
	default:
		break;
	}
	...
	case 0:
		break;
	case 1:
		add_sc(BOR_LOTUS_COMBO_8, SC_SLEEP);
		break;
	case 2:
		add_sc(BOR_LOTUS_COMBO_8, SC_STUN);
		break;
	case 3:
		add_sc(BOR_LOTUS_COMBO_8, SC_CONFUSION);
		break;
	case 4:
		add_sc(BOR_LOTUS_COMBO_8, SC_BLIND);
		break;
	case 5:
		add_sc(BOR_LOTUS_COMBO_128, SC_BLOODING);
		break;
	...
	case 0:
		break;
	case 1:
		add_sc(BOR_LOTUS_COMBO_16, SC_SLEEP);
		break;
	case 2:
		add_sc(BOR_LOTUS_COMBO_16, SC_STUN);
		break;
	case 3:
		add_sc(BOR_LOTUS_COMBO_16, SC_CONFUSION);
		break;
	case 4:
		add_sc(BOR_LOTUS_COMBO_16, SC_BLIND);
		break;
	case 5:
		add_sc(BOR_LOTUS_COMBO_128, SC_BLOODING);
		break;
	...
	case 0:
		break;
	case 1:
		add_sc(BOR_LOTUS_COMBO_32, SC_SLEEP);
		break;
	case 2:
		add_sc(BOR_LOTUS_COMBO_32, SC_STUN);
		break;
	case 3:
		add_sc(BOR_LOTUS_COMBO_32, SC_CONFUSION);
		break;
	case 4:
		add_sc(BOR_LOTUS_COMBO_32, SC_BLIND);
		break;
	case 5:
		add_sc(BOR_LOTUS_COMBO_128, SC_BLOODING);
		break;
	...
	case 0:
		break;
	case 1:
		add_sc(BOR_LOTUS_COMBO_64, SC_SLEEP);
		break;
	case 2:
		add_sc(BOR_LOTUS_COMBO_64, SC_STUN);
		break;
	case 3:
		add_sc(BOR_LOTUS_COMBO_64, SC_CONFUSION);
		break;
	case 4:
		add_sc(BOR_LOTUS_COMBO_64, SC_BLIND);
		break;
	case 5:
		add_sc(BOR_LOTUS_COMBO_128, SC_BLOODING);
		break;
	...
	case 0:
		break;
	case 1:
		add_sc(BOR_LOTUS_COMBO_128, SC_SLEEP);
		break;
	case 2:
		add_sc(BOR_LOTUS_COMBO_128, SC_STUN);
		break;
	case 3:
		add_sc(BOR_LOTUS_COMBO_128, SC_CONFUSION);
		break;
	case 4:
		add_sc(BOR_LOTUS_COMBO_128, SC_BLIND);
		break;
	case 5:
		add_sc(BOR_LOTUS_COMBO_128, SC_BLOODING);
		break;
	...
	**/
	...
	status->set_sc(SR_GENTLETOUCH_CHANGE, SC_GENTLETOUCH_CHANGE, SI_GENTLETOUCH_CHANGE, SCB_BATK);
	status->set_sc(SR_GENTLETOUCH_CURE,SC_GENTLETOUCH_CURE, SI_BLANK, SCB_NONE);
	...
	status->set_sc(BOR_BYAK_FULL, SC_FLASHCOMBO, SI_FLASHCOMBO, SCB_WATK);
	/**
	* Wanderer / Minstrel
	**/
	...
	**/
	...
	status->set_sc(RL_HEAT_BARREL, SC_HEAT_BARREL, SI_HEAT_BARREL, SCB_FLEE | SCB_ASPD);
	...
	**/
	...
	status->set_sc(GN_SLINGITEM_RANGEMELEEATK, SC_BANANA_BOMB, SI_BANANA_BOMB, SCB_LUK);
	status->set_sc(GN_SLINGITEM_RANGEMELEEATK, SC_MELON_BOMB, SI_MELON_BOMB, SCB_ASPD | SCB_SPEED);
	...
	//Icones de Buffs - War of Renegades
	//[Luminus] PedroDKS 14/04/2022
	status->dbs->IconChangeTable[SC_PORTOES_01] = SI_PORTOES_01;
	status->dbs->IconChangeTable[SC_PORTOES_02] = SI_PORTOES_02;
	status->dbs->IconChangeTable[SC_PORTOES_03] = SI_PORTOES_03;
	status->dbs->IconChangeTable[SC_PORTOES_04] = SI_PORTOES_04;
	status->dbs->IconChangeTable[SC_PORTOES_05] = SI_PORTOES_05;
	status->dbs->IconChangeTable[SC_PORTOES_06] = SI_PORTOES_06;
	status->dbs->IconChangeTable[SC_PORTOES_07] = SI_PORTOES_07;
	status->dbs->IconChangeTable[SC_PORTOES_08] = SI_PORTOES_08;
	status->dbs->IconChangeTable[SC_PORTOESDEBUFF_01] = SI_PORTOESDEBUFF_01;
	status->dbs->IconChangeTable[SC_PORTOESDEBUFF_02] = SI_PORTOESDEBUFF_02;
	status->dbs->IconChangeTable[SC_PORTOESDEBUFF_03] = SI_PORTOESDEBUFF_03;
	status->dbs->IconChangeTable[SC_PORTOESDEBUFF_04] = SI_PORTOESDEBUFF_04;
	status->dbs->IconChangeTable[SC_PORTOESDEBUFF_05] = SI_PORTOESDEBUFF_05;
	status->dbs->IconChangeTable[SC_PORTOESDEBUFF_06] = SI_PORTOESDEBUFF_06;
	status->dbs->IconChangeTable[SC_PORTOESDEBUFF_07] = SI_PORTOESDEBUFF_07;
	status->dbs->IconChangeTable[SC_PORTOESDEBUFF_08] = SI_PORTOESDEBUFF_08;
	status->dbs->IconChangeTable[SC_BAIKANOJUTSU_VERDE] = SI_BAIKANOJUTSU_VERDE;
	status->dbs->IconChangeTable[SC_BAIKANOJUTSU_AMARELA] = SI_BAIKANOJUTSU_AMARELA;
	status->dbs->IconChangeTable[SC_BAIKANOJUTSU_VERMELHA] = SI_BAIKANOJUTSU_VERMELHA;
	status->dbs->IconChangeTable[SC_SHARINGAN] = SI_SHARINGAN;
	status->dbs->IconChangeTable[SC_SHARINGAN02] = SI_SHARINGAN02;
	status->dbs->IconChangeTable[SC_SHARINGAN03] = SI_SHARINGAN03;
	status->dbs->IconChangeTable[SC_SHARINGAN04] = SI_SHARINGAN04;
	status->dbs->IconChangeTable[SC_FUIN01] = SI_FUIN_01;
	status->dbs->IconChangeTable[SC_FUIN02] = SI_FUIN_02;
	status->dbs->IconChangeTable[SC_FUIN03] = SI_FUIN_03;
	status->dbs->IconChangeTable[SC_FUIN04] = SI_FUIN_04;
	status->dbs->IconChangeTable[SC_FUIN05] = SI_FUIN_05;
	status->dbs->IconChangeTable[SC_FUIN06] = SI_FUIN_06;
	status->dbs->IconChangeTable[SC_FUIN07] = SI_FUIN_07;
	status->dbs->IconChangeTable[SC_FUIN08] = SI_FUIN_08;
	status->dbs->IconChangeTable[SC_CU] = SI_CU;
	status->dbs->IconChangeTable[SC_BYAKUGAN] = SI_BYAKUGAN;
	status->dbs->ChangeFlagTable[SC_CU] |= SCB_ALL;
	status->dbs->IconChangeTable[SC_SHARINGAN05] = SI_SHARINGAN05;
	status->dbs->IconChangeTable[SC_SHARINGAN06] = SI_SHARINGAN06;
	status->dbs->IconChangeTable[SC_MSSAPO] = SI_MSSAPO;
	status->dbs->IconChangeTable[SC_MSCOBRA] = SI_MSCOBRA;
	status->dbs->IconChangeTable[SC_BAIKANOJUTSU] = SI_BAIKANOJUTSU;
	status->dbs->IconChangeTable[SC_GENTLETOUCH_CURE] = SI_GENTLETOUCH_CURE;
	status->dbs->IconChangeTable[SC_GENTLETOUCH_CHANGE] = SI_GENTLETOUCH_CHANGE;
	status->dbs->IconChangeTable[SC_LKCONCENTRATION] = SI_LKCONCENTRATION;

	//Efeitos de buff para alterar os atributos
	//[Luminus] PedroDKS
	status->dbs->ChangeFlagTable[SC_BAIKANOJUTSU] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_BAIKADEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOES_01] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOESDEBUFF_01] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_BYAKUGAN] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_BYAKDEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_ROKUJUYON] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_ROKUJUYONDEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_LOTUSOC] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_LOTUSDEBUFFOC] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_HIJUTSU] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_HIJUTSUDEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINGAN] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINGANDEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SUSANOO] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SUSANOODEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINT01DEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINT03DEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINMANGSASDEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINMANGITADEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINMANGOBIDEBUFF] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINGAN02] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINGAN03] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINGAN04] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINGAN05] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_SHARINGAN06] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_FUIN01] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_FUIN02] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_FUIN03] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_FUIN04] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_FUIN05] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_FUIN06] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_FUIN07] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_FUIN08] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOES_02] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOES_03] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOES_04] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOES_05] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOES_06] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOES_07] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOES_08] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOESDEBUFF_02] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOESDEBUFF_03] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOESDEBUFF_04] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOESDEBUFF_05] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOESDEBUFF_06] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOESDEBUFF_07] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_PORTOESDEBUFF_08] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_BAIKANOJUTSU_AMARELA] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_BAIKANOJUTSU_VERMELHA] |= SCB_ALL;
	status->dbs->ChangeFlagTable[SC_BAIKANOJUTSU_VERDE] |= SCB_ALL;
...
int status_damage(struct block_list* src, struct block_list* target, int64 in_hp, int64 in_sp, int walkdelay, int flag) {
	...
	if (sc && sc->data[SC_KAIZEL] && !map_flag_gvg2(target->m)) {
		...
		clif->skill_nodamage(target, target, BOR_MEDICINA01, 1, 1);
...
int status_check_skilluse(struct block_list* src, struct block_list* target, uint16 skill_id, int flag) {
	...
	if (sd != NULL && sd->block_action.skill && skill_id != BOR_BYAK_ENC) // *pcblock script command
		return 0;
		...
		if (src != NULL && (sd == NULL || sd->skillitem == 0)) {
			...
			for (i = 0; i < map->list[src->m].zone->disabled_skills_count; i++) {
				if (skill_id == map->list[src->m].zone->disabled_skills[i]->nameid && (map->list[src->m].zone->disabled_skills[i]->type & src->type)) {
					if (src->type == BL_PC) {
						if (map->getcell(src->m, src, src->x, src->y, CELL_CHKPVP))
							break;
			...
			if (map->getcell(src->m, src, src->x, src->y, CELL_CHKPVP) && skill_id == TK_HIGHJUMP) {
				clif->msgtable(sd, MSG_IMPOSSIBLE_SKILL_AREA); // This skill cannot be used within this area
				return 0;
			}
		}
	...
	if (sc && sc->count) {
		...
		if (sc->data[SC_NARA_03]) {
			switch (sc->data[SC_NARA_03]->val1)
			{
	...
	if ((skill->get_ele(skill_id, 1) == ELE_EARTH && skill_id != MG_STONECURSE) // Ground type
		|| (flag & 1 && skill->get_nk(skill_id) & NK_NO_DAMAGE && skill_id != BOR_MEDICINA01)) // Buff/debuff skills started before hiding
		hide_flag &= ~OPTION_HIDE;
...
unsigned int status_get_base_maxsp(const struct map_session_data* sd, const struct status_data* st)
{
	...
	return (unsigned int)cap_value(val, 0, 10000);
}

//pedrodks
//formula de hp convertida para a base naruto
unsigned int status_get_base_maxhp(const struct map_session_data* sd, const struct status_data* st)
{
	...
	return (unsigned int)cap_value(val, 0, 300000);
}
...
int status_calc_pc_(struct map_session_data* sd, enum e_status_calc_opt opt) {
	...
	if (sc->count && sc->data[SC_BAIKANOJUTSU]) {
		struct item_data* data = itemdb->exists(sc->data[SC_BAIKANOJUTSU]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_BAIKANOJUTSU_VERDE]) {
		struct item_data* data = itemdb->exists(sc->data[SC_BAIKANOJUTSU_VERDE]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_BAIKANOJUTSU_AMARELA]) {
		struct item_data* data = itemdb->exists(sc->data[SC_BAIKANOJUTSU_AMARELA]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_BAIKANOJUTSU_VERMELHA]) {
		struct item_data* data = itemdb->exists(sc->data[SC_BAIKANOJUTSU_VERMELHA]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_BAIKADEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_BAIKADEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_VERDEDEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_VERDEDEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_AMARELADEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_AMARELADEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_VERMELHADEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_VERMELHADEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOES_01]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOES_01]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOES_02]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOES_02]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOES_03]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOES_03]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOES_04]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOES_04]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOES_05]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOES_05]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOES_06]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOES_06]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOES_07]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOES_07]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOES_08]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOES_08]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOESDEBUFF_01]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOESDEBUFF_01]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOESDEBUFF_02]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOESDEBUFF_02]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOESDEBUFF_03]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOESDEBUFF_03]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOESDEBUFF_04]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOESDEBUFF_04]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOESDEBUFF_05]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOESDEBUFF_05]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOESDEBUFF_06]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOESDEBUFF_06]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOESDEBUFF_07]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOESDEBUFF_07]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_PORTOESDEBUFF_08]) {
		struct item_data* data = itemdb->exists(sc->data[SC_PORTOESDEBUFF_08]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_BYAKUGAN]) {
		struct item_data* data = itemdb->exists(sc->data[SC_BYAKUGAN]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_BYAKDEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_BYAKDEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_ROKUJUYON]) {
		struct item_data* data = itemdb->exists(sc->data[SC_ROKUJUYON]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_ROKUJUYONDEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_ROKUJUYONDEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_LOTUSOC]) {
		struct item_data* data = itemdb->exists(sc->data[SC_LOTUSOC]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_LOTUSDEBUFFOC]) {
		struct item_data* data = itemdb->exists(sc->data[SC_LOTUSDEBUFFOC]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_HIJUTSU]) {
		struct item_data* data = itemdb->exists(sc->data[SC_HIJUTSU]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_HIJUTSUDEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_HIJUTSUDEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINGAN]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINGAN]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINGAN02]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINGAN02]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINGAN03]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINGAN03]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINGAN04]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINGAN04]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINGAN05]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINGAN05]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINGAN06]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINGAN06]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINGANDEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINGANDEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SUSANOO]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SUSANOO]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SUSANOODEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SUSANOODEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINT01DEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINT01DEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINT02DEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINT02DEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINT03DEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINT03DEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINMANGSASDEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINMANGSASDEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINMANGITADEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINMANGITADEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_SHARINMANGOBIDEBUFF]) {
		struct item_data* data = itemdb->exists(sc->data[SC_SHARINMANGOBIDEBUFF]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_MSSAPO]) {
		struct item_data* data = itemdb->exists(sc->data[SC_MSSAPO]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_MSCOBRA]) {
		struct item_data* data = itemdb->exists(sc->data[SC_MSCOBRA]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_BYAKAVAN]) {
		struct item_data* data = itemdb->exists(sc->data[SC_BYAKAVAN]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_GBUFFESC]) {
		struct item_data* data = itemdb->exists(sc->data[SC_GBUFFESC]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_FUIN01]) {
		struct item_data* data = itemdb->exists(sc->data[SC_FUIN01]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_FUIN02]) {
		struct item_data* data = itemdb->exists(sc->data[SC_FUIN02]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_FUIN03]) {
		struct item_data* data = itemdb->exists(sc->data[SC_FUIN03]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_FUIN04]) {
		struct item_data* data = itemdb->exists(sc->data[SC_FUIN04]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_FUIN05]) {
		struct item_data* data = itemdb->exists(sc->data[SC_FUIN05]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_FUIN06]) {
		struct item_data* data = itemdb->exists(sc->data[SC_FUIN06]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_FUIN07]) {
		struct item_data* data = itemdb->exists(sc->data[SC_FUIN07]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}

	if (sc->count && sc->data[SC_FUIN08]) {
		struct item_data* data = itemdb->exists(sc->data[SC_FUIN08]->val1);
		if (data && data->script)
			script->run_use_script(sd, data, 0);
	}
...
void status_calc_bl_main(struct block_list* bl, /*enum scb_flag*/int flag) {
	...
	**/
	...
	if (flag & SCB_MDEF) {
		...
		if (bl->type & BL_PC) {//pedrodks mdef
			int woemdef_div = battle_config.ero_mdef_divi;
			if (woemdef_div > 99) {
				woemdef_div = 99;
			}
			else if (woemdef_div < 0) {
				woemdef_div = 0;
			}
			if (woemdef_div > 0) {
				if (st->mdef > woemdef_div) {
					st->mdef = woemdef_div;
				}
			}
		}
...
int status_base_amotion_pc(struct map_session_data* sd, struct status_data* st) {
	...
	// BORUTO ASPD
    	amotion = 500 - (st->agi/7)*10 - (st->dex/15)*10;
...
unsigned short status_base_atk(const struct block_list* bl, const struct status_data* st) {
	...
	if (bl->type == BL_PC)
		str += dex / 5 + st->luk / 5;
#endif
	return cap_value(str, 0, battle_config.bor_atk_base_limit);
...
void status_calc_misc(struct block_list* bl, struct status_data* st, int level) {
	...
	st->def2 += st->vit;
	st->mdef2 += (st->int_ + (st->vit >> 1)) / battle_config.ero_mdef2_divi;
#endif // RENEWAL
...
unsigned short status_calc_agi(struct block_list* bl, struct status_change* sc, int agi)
{
	...
	if (sc->data[SC_NJ_SUITON] && sc->data[SC_NJ_SUITON]->val3)
		agi -= agi * sc->data[SC_NJ_SUITON]->val2 / 100;
	if (sc->data[SC_MARIONETTE_MASTER])
...
signed short status_calc_flee(struct block_list* bl, struct status_change* sc, int flee, bool viewable) {
	...
	if (bl->type == BL_PC && map->list[bl->m].flag.zombie)
		return (short)cap_value(1, 1, SHRT_MAX);
...
unsigned short status_calc_speed(struct block_list* bl, struct status_change* sc, int speed)
{
	...
	if (bl->type == BL_PC && map->list[bl->m].flag.speedmf) {
		if (sd->disguise != -1)
			return (unsigned short)cap_value(110, MIN_WALK_SPEED, MAX_WALK_SPEED);
		else
			return (unsigned short)cap_value(100, MIN_WALK_SPEED, MAX_WALK_SPEED);
	}
...
int status_change_start(struct block_list* src, struct block_list* bl, enum sc_type type, int rate, int val1, int val2, int val3, int val4, int tick, int flag) {
	...
	if (!(flag & SCFLAG_LOADED)) { // Do not parse val settings when loading SCs
		...
		case SC_DELUGE:
			...
			break;
		case SC_NJ_SUITON:
                	if (val2 == 0 || (sd != NULL && &sd->bl == src)) {
                    	//No penalties.
                    	val2 = 0; //Agi penalty
                    	val3 = 0; //Walk speed penalty
                    	val4 = 10; //Water elemental damage
                    	break;
                	}
                	val3 = 20;
                	val2 = 20;
		...
		case SC_CONFUSION:
			...
			break;
		case SC_BLOODING:
			if (battle_config.sang_mode == 0) {
				val4 = tick / 10000;
				if (!val4) val4 = 1;
				tick_time = 10000; // [GodLesZ] tick time
			}
			else {
				val4 = tick / battle_config.sang_time;
				if (!val4) val4 = 1;
				tick_time = battle_config.sang_time;
			}
			break;
		case SC_S_LIFEPOTION:
		case SC_L_LIFEPOTION:
		...
		case SC_CLOAKING:
			...
			tick = INFINITE_DURATION; // duration sent to the client should be infinitetick = -1;
...
#undef PER
		...
		// @aura
		if (sd && sd->status.aura > 0 && (type == SC_HIDING || type == SC_CLOAKING || type == SC_CHASEWALK || sd->sc.option == OPTION_INVISIBLE || type == SC_CHASEWALK || type == SC_CHASEWALK2 || type == SC_CAMOUFLAGE)) {
			sd->status.aura *= -1;
			clif->clearunit_area(&sd->bl, 0);
			clif->getareachar_char(&sd->bl, 0);
		}
	}
...
bool status_end_sc_before_start(struct block_list* bl, struct status_data* st, struct status_change* sc, enum sc_type type, int undead_flag, int val1, int val2, int val3, int val4)
{
	...
	case SC_SONG_OF_MANA:
	case SC_DANCE_WITH_WUG:
		if (type != SC_NARA) status_change_end(bl, SC_NARA, INVALID_TIMER);
...
int status_change_end_(struct block_list* bl, enum sc_type type, int tid, const char* file, int line) {
	...
	case SC_NARA_03:
		if (sce->val4) {
			...
			sce->val4 = 0;
			if (tbl && tsc && tsc->data[SC_NARA_03]) {
				tsc->data[SC_NARA_03]->val4 = 0;
				status_change_end(tbl, SC_NARA_03, INVALID_TIMER);
			}
	...
	case SC_AUTOTRADE:
		...
		if (sd) {
			map->quit(sd);
			// Because map->quit calls status_change_end with tid INVALID_TIMERif( tid == -1 || !src)
	...
	case SC_H_MINE:
	{
		...
		it.identify = 1;
		map->addflooritem(bl, &it, it.amount, bl->m, bl->x, bl->y, caster->status.char_id, 0, 0, 4, false);
	}
	break;
	case SC_HEAT_BARREL:
		if (sd)
	...
	case SC_BAIKANOJUTSU:
	case SC_BAIKANOJUTSU_VERDE:
	case SC_BAIKANOJUTSU_AMARELA:
	case SC_BAIKANOJUTSU_VERMELHA:
		switch (pc_readglobalreg(sd, script->add_variable("BAIKA")))
		{
		case 1:
			if (sd) {
				npc->event(sd, "baika::OnBaikaDebuff", 0);
			}
			pc_setglobalreg(sd, script->add_variable("BAIKA"), 0);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3050)); //O tempo do Baika no Jutsu acabou.
			break;
		case 2:
			if (sd) {
				npc->event(sd, "baika::OnVerdeDebuff", 0);
			}
			pc_setglobalreg(sd, script->add_variable("BAIKA"), 0);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3051)); //O tempo da Pílula Verde acabou.
			break;
		case 3:
			if (sd) {
				npc->event(sd, "baika::OnAmarelaDebuff", 0);
			}
			pc_setglobalreg(sd, script->add_variable("BAIKA"), 0);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3052)); //O tempo da Pílula Amarela acabou.
			break;
		case 4:
			if (sd) {
				npc->event(sd, "baika::OnVermelhaDebuff", 0);
			}
			pc_setglobalreg(sd, script->add_variable("BAIKA"), 0);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3053)); //O tempo da Pílula Vermelha acabou.
			break;
		}
		break;
	case SC_BAIKADEBUFF:
		//remover tamanho grande de baika
		//pedrodks
		...
		break;
	case SC_VERDEDEBUFF:
	case SC_AMARELADEBUFF:
	case SC_VERMELHADEBUFF:
		pc_setglobalreg(sd, script->add_variable("BAIKA"), 0);
		break;
	//pedrodks
	//portoes de chakra
	//buff
	case SC_PORTOES_01:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3055)); // O portão foi aberto.
		if (sd) {
			npc->event(sd, "portoes::OnPor01Debuff", 0);
		}
		break;
	case SC_PORTOES_02:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3056)); // O portão foi aberto.
		if (sd) {
			npc->event(sd, "portoes::OnPor02Debuff", 0);
		}
		break;
	case SC_PORTOES_03:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3057)); // O portão foi aberto.
		if (sd) {
			npc->event(sd, "portoes::OnPor03Debuff", 0);
		}
		break;
	case SC_PORTOES_04:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3058)); // O portão foi aberto.
		if (sd) {
			npc->event(sd, "portoes::OnPor04Debuff", 0);
		}
		break;
	case SC_PORTOES_05:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3059)); // O portão foi aberto.
		if (sd) {
			npc->event(sd, "portoes::OnPor05Debuff", 0);
		}
		break;
	case SC_PORTOES_06:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3060)); // O portão foi aberto.
		if (sd) {
			npc->event(sd, "portoes::OnPor06Debuff", 0);
		}
		break;
	case SC_PORTOES_07:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3061)); // O portão foi aberto.
		if (sd) {
			npc->event(sd, "portoes::OnPor07Debuff", 0);
		}
		break;
	case SC_PORTOES_08:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3062)); // O portão foi aberto.
		if (sd) {
			npc->event(sd, "portoes::OnPor08Debuff", 0);
		}
		break;
		/*DESATIVADO
		switch (pc_readglobalreg(sd, script->add_variable("PORTAO")))
		{
		case 1:
			pc_setglobalreg(sd, script->add_variable("PORTAODEBUFF"), 1);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3055)); // O portão foi aberto.
			if (sd) {
				npc->event(sd, "portoes::OnPor01Debuff", 0);
			}
			break;
		case 2:
			pc_setglobalreg(sd, script->add_variable("PORTAODEBUFF"), 2);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3056)); // O portão foi aberto.
			if (sd) {
				npc->event(sd, "portoes::OnPor02Debuff", 0);
			}
			break;
		case 3:
			pc_setglobalreg(sd, script->add_variable("PORTAODEBUFF"), 3);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3057)); // O portão foi aberto.
			if (sd) {
				npc->event(sd, "portoes::OnPor03Debuff", 0);
			}
			break;
		case 4:
			pc_setglobalreg(sd, script->add_variable("PORTAODEBUFF"), 4);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3058)); // O portão foi aberto.
			if (sd) {
				npc->event(sd, "portoes::OnPor04Debuff", 0);
			}
			break;
		case 5:
			pc_setglobalreg(sd, script->add_variable("PORTAODEBUFF"), 5);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3059)); // O portão foi aberto.
			if (sd) {
				npc->event(sd, "portoes::OnPor05Debuff", 0);
			}
			break;
		case 6:
			pc_setglobalreg(sd, script->add_variable("PORTAODEBUFF"), 6);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3060)); // O portão foi aberto.
			if (sd) {
				npc->event(sd, "portoes::OnPor06Debuff", 0);
			}
			break;
		case 7:
			pc_setglobalreg(sd, script->add_variable("PORTAODEBUFF"), 7);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3061)); // O portão foi aberto.
			if (sd) {
				npc->event(sd, "portoes::OnPor07Debuff", 0);
			}
			break;
		case 8:
			pc_setglobalreg(sd, script->add_variable("PORTAODEBUFF"), 8);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3062)); // O portão foi aberto.
			if (sd) {
				npc->event(sd, "portoes::OnPor08Debuff", 0);
			}
		...
		*/
	case SC_PORTOESDEBUFF_01:
	case SC_PORTOESDEBUFF_02:
	case SC_PORTOESDEBUFF_03:
	case SC_PORTOESDEBUFF_04:
	case SC_PORTOESDEBUFF_05:
	case SC_PORTOESDEBUFF_06:
	case SC_PORTOESDEBUFF_07:
	case SC_PORTOESDEBUFF_08:
		break;
		/*DESATIVADO
		//pedrodks
		//portoes de chakra
		//debuff
		switch (pc_readglobalreg(sd, script->add_variable("PORTAODEBUFF")))
		{
		case 1:
			pc_setglobalreg(sd, script->add_variable("PORTAO"), 0);
//			clif->messagecolor_self(sd->fd, COLOR_YELLOW, msg_fd(sd->fd, 3069)); // Você já pode abrir o portão
		case 2:
			pc_setglobalreg(sd, script->add_variable("PORTAO"), 0);
//			clif->messagecolor_self(sd->fd, COLOR_YELLOW, msg_fd(sd->fd, 3070)); // Você já pode abrir o portão
			break;
		case 3:
			pc_setglobalreg(sd, script->add_variable("PORTAO"), 0);
//			clif->messagecolor_self(sd->fd, COLOR_YELLOW, msg_fd(sd->fd, 3071)); // Você já pode abrir o portão
			break;
		case 4:
			pc_setglobalreg(sd, script->add_variable("PORTAO"), 0);
//			clif->messagecolor_self(sd->fd, COLOR_YELLOW, msg_fd(sd->fd, 3072)); // Você já pode abrir o portão
			break;
		case 5:
			pc_setglobalreg(sd, script->add_variable("PORTAO"), 0);
//			clif->messagecolor_self(sd->fd, COLOR_YELLOW, msg_fd(sd->fd, 3073)); // Você já pode abrir o portão
			break;
		case 6:
			pc_setglobalreg(sd, script->add_variable("PORTAO"), 0);
//			clif->messagecolor_self(sd->fd, COLOR_YELLOW, msg_fd(sd->fd, 3074)); // Você já pode abrir o portão
			break;
		case 7:
			pc_setglobalreg(sd, script->add_variable("PORTAO"), 0);
//			clif->messagecolor_self(sd->fd, COLOR_YELLOW, msg_fd(sd->fd, 3075)); // Você já pode abrir o portão
			break;
		case 8:
			pc_setglobalreg(sd, script->add_variable("PORTAO"), 0);
//			pc->changelook(sd, LOC_NRO_CABELO, sd->vd.bor_s_cabelo);
//			clif->messagecolor_self(sd->fd, COLOR_YELLOW, msg_fd(sd->fd, 3067)); // Todos os portões que foram aberto se fecharam! E você está perto de morrer devido as consequências. Vai tentar abrir eles novamente?
			break;

		}
		break;
		*/
	case SC_PORTOESLIMIT:
		if (pc_readglobalreg(sd, script->add_variable("PORTAOLIMITE")) == 1) {
//			pc_setglobalreg(sd, script->add_variable("PORTAO"), 0);
			pc_setglobalreg(sd, script->add_variable("PORTAOLIMITE"), 0);
			clif->messagecolor_self(sd->fd, COLOR_YELLOW, msg_fd(sd->fd, 3086)); //Seu corpo fechou devido aos efeitos dos portões.
//			sd->borportoespegou = 0;
		}
		break;
	case SC_BYAKUGAN:
		if (sd) {
			npc->event(sd, "byakugan::OnByakDebuff", 0);
			clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3079));// O Byakugan foi desativado.
			pc_setglobalreg(sd, script->add_variable("BYAK"), 0);
		}
		break;
	case SC_BYAKDEBUFF:
		break;
	...
	case SC_ROKUJUYON:
		if (sd) {
			npc->event(sd, "byakugan::OnRokujuyonDebuff", 0);
		}
		break;
	case SC_ROKUJUYONDEBUFF:
		break;
	case SC_ROKUJUYONEFFECT:
		if (sd) {
			npc->event(sd, "byakugan::OnRokujuyonEf", 0);
		}
		break;

	case SC_LOTUSOC:
		if (sd) {
			npc->event(sd, "portoes::OnLotusDebuffOc", 0);
		}
		break;
	case SC_LOTUSDEBUFFOC:
		break;
	case SC_LOTUSEFFECTOC:
		if (sd) {
			npc->event(sd, "portoes::OnLotusEfOc", 0);
		}
		break;

	case SC_HIJUTSU:
		if (sd) {
			npc->event(sd, "hyoton::OnHijutsuDebuff", 0);
		}
		break;
	case SC_HIJUTSUDEBUFF:
		pc_setglobalreg(sd, script->add_variable("HYOTON"), 0);
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3081)); //Hijutsu - Makyou Hyoushou, o efeito acabou.
		break;
	case SC_HIJUTSUEFFECT:
		if (sd) {
			npc->event(sd, "hyoton::OnHijutsuEf", 0);
		}
		break;

	case SC_SHARINGAN:
		if (sd) {
			npc->event(sd, "sharingan::OnTomoe01ShaDebuff", 0);
		}
		break;
	case SC_SHARINGAN02:
		if (sd) {
			npc->event(sd, "sharingan::OnTomoe02ShaDebuff", 0);
		}
		break;
	case SC_SHARINGAN03:
		if (sd) {
			npc->event(sd, "sharingan::OnTomoe03ShaDebuff", 0);
		}
		break;
	case SC_SHARINGAN04:
		if (sd) {
			npc->event(sd, "sharingan::OnMang01ShaDebuff", 0);
		}
		break;
	case SC_SHARINGAN05:
		if (sd) {
			npc->event(sd, "sharingan::OnMang02ShaDebuff", 0);
		}
		break;
	case SC_SHARINGAN06:
		if (sd) {
			npc->event(sd, "sharingan::OnMang03ShaDebuff", 0);
		}
		break;
	case SC_MSSAPO:
		if (sd) {
			npc->event(sd, "modo_sanin::OnMsSapoDebuff", 0);
		}
		pc_setglobalreg(sd, script->add_variable("MSSAPO"), 0);
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3107)); //Modo Sábio acabou!
		break;
	case SC_MSCOBRA:
		if (sd) {
			npc->event(sd, "modo_sanin::OnMsCobraDebuff", 0);
		}
		pc_setglobalreg(sd, script->add_variable("MSCOBRA"), 0);
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3107)); //Modo Sábio acabou!
		break;
	case SC_BYAKAVAN:
		if (sd) {
			//desbloqueia ações quando o byakugan é desativado
			sd->block_action.attack = 0;
			sd->block_action.skill = 0;
			sd->block_action.useitem = 0;
			sd->block_action.chat = 0;
			sd->block_action.sitstand = 0;
			sd->block_action.commands = 0;
			npc->event(sd, "byakugan::OnByakAvanDebuff", 0);
		}
		pc_setglobalreg(sd, script->add_variable("BYAKAVAN"), 0);
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3110)); //Sua visão voltou ao normal!
		break;
	case SC_SHARINT01DEBUFF:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3088)); //Sharingan: Tomoe 01, o efeito acabou.
		pc_setglobalreg(sd, script->add_variable("SHARIN"), 0);
		break;
	case SC_SHARINT02DEBUFF:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3090)); //Sharingan: Tomoe 02, o efeito acabou.
		pc_setglobalreg(sd, script->add_variable("SHARIN"), 0);
		break;
	case SC_SHARINT03DEBUFF:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3092)); //Sharingan: Tomoe 03, o efeito acabou.
		pc_setglobalreg(sd, script->add_variable("SHARIN"), 0);
		break;
	case SC_SHARINMANGSASDEBUFF:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3094)); //Mangekyou Sharingan: Sasuke, o efeito acabou.
		pc_setglobalreg(sd, script->add_variable("SHARIN"), 0);
		break;
	case SC_SHARINMANGITADEBUFF:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3096)); //Mangekyou Sharingan: Itachi, o efeito acabou.
		pc_setglobalreg(sd, script->add_variable("SHARIN"), 0);
		break;
	case SC_SHARINMANGOBIDEBUFF:
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3098)); //Mangekyou Sharingan: Obito, o efeito acabou.
		pc_setglobalreg(sd, script->add_variable("SHARIN"), 0);
		break;
	case SC_SUSANOO:
		if (sd) {
			npc->event(sd, "Susano::OnSusanoDebuff", 0);
		}
		break;
	case SC_SUSANOODEBUFF:
		pc_setglobalreg(sd, script->add_variable("SUSAN"), 0);
		clif->messagecolor_self(sd->fd, COLOR_RED, msg_fd(sd->fd, 3102)); //A Habilidade Susanoo terminou.
		break;
	case SC_SUSANOOEFFECT:
		if (sd) {
			npc->event(sd, "Susano::OnSusanoEf", 0);
		}
		break;
	case SC_KATON01:
	case SC_SUITON01:
	...
	case SC_SUITON04:
		break;
	case SC_GBUFFESC:
		skill->castend_nodamage_id(&sd->bl, &sd->bl, 51, 10, 0, 0);
		break;
	case SC_AMATERASUTIME:
		sd->status.amaterasu_count = 0;
		break;
	case SC_FUIN01:
	case SC_FUIN02:
	case SC_FUIN03:
	...
	if (sd && sd->status.party_id && (
		type == SC_BLESSING || type == SC_INCAGI || type == SC_PROTECTWEAPON || type == SC_PROTECTSHIELD ||
		type == SC_PROTECTARMOR || type == SC_PROTECTHELM || type == SC_SOULLINK || type == SC_DEVOTION)
		) {
		struct party_data* p = party->search(sd->status.party_id);
		clif->party_info(p, NULL);
...
#define sc_timer_next(t,f,i,d) do { \
	...
	case SC_BLOODING:
		if (battle_config.sang_mode == 0) {
			...
			if (--(sce->val4) >= 0) {
				int hp = (int)(st->hp * ((battle_config.sang_hp)/100));
				struct block_list* src = map->id2bl(sce->val2);
				if (src && bl && bl->type == BL_MOB) {
					mob->log_damage(BL_UCAST(BL_MOB, bl), src, sd != NULL || hp < st->hp ? hp : st->hp - 1);
				}
				...
				if (sc->data[type]) {
					...
					sc_timer_next(battle_config.sang_time + tick, status->change_timer, bl->id, data);
				}
				map->freeblock_unlock();
				return 0;
			}
	...
	case SC_BURNING:
		if (--(sce->val4) > 0) {
			...
			damage = (int)(damage + (damage * (battle_config.queimadura_balance/100)));
	...
	for (i = SC_COMMON_MIN; i < SC_MAX; i++) {
		...
		case SC_BLOODING:
			if (battle_config.sang_mode == 0)
				...
				data.tick = sc->data[i]->val4 * battle_config.sang_time;
			break;
		default:
			continue;
		}
...
int status_bor_verificar_sc(struct map_session_data* sd, int sc_data_01, int sc_data_02)
{
	struct status_change* sc = status->get_sc(&sd->bl);

	for (int i = sc_data_01; i <= (sc_data_02); i++)
	{
		if (sc->data[i])
			return 1;
	}
...
//Função para finalizar os efeitos personalizados das kgs
//pedrodks/luminus
int status_bor_finalizar_effects(struct map_session_data* sd)
{
	struct status_change* sc = status->get_sc(&sd->bl);

	for (int i = SC_PORTOES_01; i < SC_CU; i++) {
		if (!sc->data[i] || i == SC_CU)
			continue;

		switch (i)
		{
		case SC_BAIKANOJUTSU_VERDE:
			status_change_end(&sd->bl, SC_BAIKANOJUTSU_VERDE, INVALID_TIMER);
			break;
		case SC_BAIKANOJUTSU_AMARELA:
			status_change_end(&sd->bl, SC_BAIKANOJUTSU_AMARELA, INVALID_TIMER);
			break;
		case SC_BAIKANOJUTSU_VERMELHA:
			status_change_end(&sd->bl, SC_BAIKANOJUTSU_VERMELHA, INVALID_TIMER);
			clif->hat_effect_single2(&sd->bl, skill->get_hateffect_id(899, 1), false);
			break;
		case SC_PORTOES_01:
			status_change_end(&sd->bl, SC_PORTOES_01, INVALID_TIMER);
			break;
		case SC_PORTOES_02:
			status_change_end(&sd->bl, SC_PORTOES_02, INVALID_TIMER);
			break;
		case SC_PORTOES_03:
			status_change_end(&sd->bl, SC_PORTOES_03, INVALID_TIMER);
			break;
		case SC_PORTOES_04:
			status_change_end(&sd->bl, SC_PORTOES_04, INVALID_TIMER);
			break;
		case SC_PORTOES_05:
			status_change_end(&sd->bl, SC_PORTOES_05, INVALID_TIMER);
			break;
		case SC_PORTOES_06:
			status_change_end(&sd->bl, SC_PORTOES_06, INVALID_TIMER);
			break;
		case SC_PORTOES_07:
			status_change_end(&sd->bl, SC_PORTOES_07, INVALID_TIMER);
			break;
		case SC_PORTOES_08:
			clif->hat_effect_single2(&sd->bl, skill->get_hateffect_id(921, 1), false);
			status_change_end(&sd->bl, SC_PORTOES_08, INVALID_TIMER);
			break;
		case SC_PORTOESLIMIT:
			status_change_end(&sd->bl, SC_PORTOESLIMIT, INVALID_TIMER);
			break;
		case SC_BYAKUGAN:
			status_change_end(&sd->bl, SC_BYAKUGAN, INVALID_TIMER);
			break;
		case SC_ROKUJUYON:
			status_change_end(&sd->bl, SC_ROKUJUYON, INVALID_TIMER);
			break;
		case SC_HIJUTSU:
			status_change_end(&sd->bl, SC_HIJUTSU, INVALID_TIMER);
			break;
		case SC_SHARINGAN:
			status_change_end(&sd->bl, SC_SHARINGAN, INVALID_TIMER);
			break;
		case SC_SHARINGAN02:
			status_change_end(&sd->bl, SC_SHARINGAN02, INVALID_TIMER);
			break;
		case SC_SHARINGAN03:
			status_change_end(&sd->bl, SC_SHARINGAN03, INVALID_TIMER);
			break;
		case SC_SHARINGAN04:
			status_change_end(&sd->bl, SC_SHARINGAN04, INVALID_TIMER);
			break;
		case SC_SHARINGAN05:
			status_change_end(&sd->bl, SC_SHARINGAN05, INVALID_TIMER);
			break;
		case SC_SHARINGAN06:
			status_change_end(&sd->bl, SC_SHARINGAN06, INVALID_TIMER);
			break;
		case SC_PRESERVE:
			status_change_end(&sd->bl, SC_PRESERVE, INVALID_TIMER);
			break;
		case SC_SUSANOO:
			status_change_end(&sd->bl, SC_SUSANOO, INVALID_TIMER);
			break;
		case SC_MSSAPO:
			status_change_end(&sd->bl, SC_MSSAPO, INVALID_TIMER);
			break;
		case SC_MSCOBRA:
			status_change_end(&sd->bl, SC_MSCOBRA, INVALID_TIMER);
			break;
		case SC_BYAKAVAN:
			status_change_end(&sd->bl, SC_BYAKAVAN, INVALID_TIMER);
			break;
		}
	}
	...
	if (pc_readglobalreg(sd, script->add_variable("PORTAODEBUFF")) > 0) {
		pc_setglobalreg(sd, script->add_variable("PORTAODEBUFF"), 0);
	}
	...
	if (pc_readglobalreg(sd, script->add_variable("MSSAPO")) > 0) {
		pc_setglobalreg(sd, script->add_variable("MSSAPO"), 0);
	}

	if (pc_readglobalreg(sd, script->add_variable("MSCOBRA")) > 0) {
		pc_setglobalreg(sd, script->add_variable("MSCOBRA"), 0);
	}

	if (pc_readglobalreg(sd, script->add_variable("BYAKAVAN")) > 0) {
		pc_setglobalreg(sd, script->add_variable("BYAKAVAN"), 0);
	}
...
#else
	const char* config_filename = "db/borutodb/job_db.conf";
#endif
...
int status_readdb(void)
{
	...
	sv_readsqldb(get_database_name(53), 25, MAX_SINGLE_WEAPON_TYPE, status->readdb_sizefix);
...
void buffspecial_db(void) {
	struct config_t buffspecial_conf;
	struct config_setting_t* it = NULL, * buffspecial = NULL;
#ifdef RENEWAL
	const char* config_filename = "db/re/BuffSpecial.conf"; // FIXME hardcoded name
#else
	const char* config_filename = "db/borutodb/BuffSpecial.conf"; // FIXME hardcoded name
#endif

	int scname = 0, i = 0, sc_count = 0;
	const char* str = NULL;

	if (libconfig->load_file(&buffspecial_conf, config_filename))
		return;
	...
	if (buffspecial != NULL && (it = libconfig->setting_get_elem(buffspecial, 0)) != NULL) {
		for (i = 0; i < sc_count; ++i) {
			struct config_setting_t* scbuff = libconfig->setting_get_elem(buffspecial, i);
			int type;
...
void status_defaults(void) {
	...
	status->bor_finalizar_effects = status_bor_finalizar_effects;
	status->bor_verificar_sc = status_bor_verificar_sc;
}
